 ...
 */
definition(
    name: "Notify If Alarm State Changes",
    namespace: "Mavrrick",
    author: "CRAIG KING",
    description: "Improved notification if ADT Alarm state changes ",
...
preferences {
	section("Send this message if alarm changes to Disarmed"){
		input "messageDisarmed", "text", title: "Message Text", required: true
	}
	section("Send this message if alarm changes to Armed/Away"){
		input "messageArmedAway", "text", title: "Message Text", required: true
	}
	section("Send this message if alarm changes to Armed/Stay"){
		input "messageArmedStay", "text", title: "Message Text", required: true
	}
